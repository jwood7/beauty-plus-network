      ...
      <div className={whyBeautyHero}>
        <HeroImage
          ...
          >
            ...
            <Link to="/how-it-works/our-impact" className={`${magenta} ${button}`}>See Our Impact</Link>
          </HeroImage>
      </div>
      <div className={pageMain}>
        <div className={tripleColumn}>
          <div className={columnItem}>
            ...
            <Link to="/beauty-is-power" className={`${red} ${button}`}>Meet Jasmine</Link>
          </div>
          <div className={columnItem}>
            ...
            <Link to="/how-it-works" className={`${orange} ${button}`}>How It Works</Link>
          </div>
          <div className={columnItem}>
            ...
            <Link to="/who-we-are" className={`${pink} ${button}`}>Meet Our Team</Link>
          </div>
        </div>
        </div>
      </div>
