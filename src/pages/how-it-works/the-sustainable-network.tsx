...
import {orange, pink, button, pageFAQs, leftRow} from '../pages.module.css'
  ...
  return (
    <Layout pageTitle={"The Sustainable Network"}>
      ...
      <div className={`${pageFAQs}`}>
        ...
        <p>We do more than just train our students, we connect them to the knowledge and people they need to succeed before and after they graduate.</p>
      </div>
